...
Это **учебный проект по компьютерному зрению и автоматизации**. Любой сторонний софт, автоматизирующий действия в игре, формально попадает под определение читов в **Valve / Steam Subscriber Agreement** — даже для одиночной ивент-мини-игры без PvP. Вы используете его **на свой страх и риск**; авторы не несут ответственности за возможные санкции к аккаунту. Бот **не** читает память игры, **не** внедряется в процесс и **не** обходит анти-чит — только смотрит на экран и нажимает клавиши.
...
Планы и задачи — в [BACKLOG.md](BACKLOG.md) и [ROADMAP.md](ROADMAP.md). Кратко дальше: устойчивость на старших уровнях (новые цвета блоков), прицельное выбивание блоков, поддержка иных разрешений.
